...
//    }
//
//    override fun onBindViewHolder(holder2: GetViewHolder, position: Int) {
//        val items = paginaWeb.items.get(position)
//        holder2.view.tituloPr.text = items.labels_url
//        holder2.view.bodyPr.text = items.pulls_url
//        holder2.view.autor_Name2.text = items.name
//        holder2.view.nome_Completo2.text = items.full_name
//    }
//
